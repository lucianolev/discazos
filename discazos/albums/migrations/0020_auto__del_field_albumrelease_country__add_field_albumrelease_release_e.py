...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumRelease.release_extra_info'
        db.add_column('albums_albumrelease', 'release_extra_info', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'AlbumRelease.release_year'
        db.alter_column('albums_albumrelease', 'release_year', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=4))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AlbumRelease.release_extra_info'
        db.delete_column('albums_albumrelease', 'release_extra_info')

        # Changing field 'AlbumRelease.release_year'
        db.alter_column('albums_albumrelease', 'release_year', self.gf('django.db.models.fields.IntegerField')(max_length=4, null=True))
