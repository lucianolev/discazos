...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Album.wikipedia'
        db.delete_column('albums_album', 'wikipedia')

        # Deleting field 'Artist.wikipedia'
        db.delete_column('albums_artist', 'wikipedia')


    def backwards(self, orm):
        
        # Adding field 'Album.wikipedia'
        db.add_column('albums_album', 'wikipedia', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)

        # Adding field 'Artist.wikipedia'
        db.add_column('albums_artist', 'wikipedia', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)
    ...
    models = {
        ...
        'albums.albumrelease': {
            ...
            'release_year': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
