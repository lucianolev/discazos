...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DiscTrack.song'
        db.delete_column('albums_disctrack', 'song_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DiscTrack.song'
        raise RuntimeError("Cannot reverse this migration. 'DiscTrack.song' and its values cannot be restored.")
