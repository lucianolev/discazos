...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'AlbumRelease.release_year'
        raise RuntimeError("Cannot reverse this migration. 'AlbumRelease.release_year' and its values cannot be restored.")
