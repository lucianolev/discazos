...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'CompilationAlbumRelease.compilationalbum_ptr'
        db.delete_column('albums_compilationalbumrelease', 'compilationalbum_ptr_id')

        # Adding field 'CompilationAlbumRelease.album'
        db.add_column('albums_compilationalbumrelease', 'album', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='releases', to=orm['albums.CompilationAlbum']), keep_default=False)

        # Changing field 'CompilationAlbumRelease.albumrelease_ptr'
        db.alter_column('albums_compilationalbumrelease', 'albumrelease_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['albums.AlbumRelease'], unique=True, primary_key=True))

        # Deleting field 'ArtistAlbumRelease.artistalbum_ptr'
        db.delete_column('albums_artistalbumrelease', 'artistalbum_ptr_id')

        # Adding field 'ArtistAlbumRelease.album'
        db.add_column('albums_artistalbumrelease', 'album', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='releases', to=orm['albums.ArtistAlbum']), keep_default=False)

        # Changing field 'ArtistAlbumRelease.albumrelease_ptr'
        db.alter_column('albums_artistalbumrelease', 'albumrelease_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['albums.AlbumRelease'], unique=True, primary_key=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'CompilationAlbumRelease.compilationalbum_ptr'
        raise RuntimeError("Cannot reverse this migration. 'CompilationAlbumRelease.compilationalbum_ptr' and its values cannot be restored.")

        # Deleting field 'CompilationAlbumRelease.album'
        db.delete_column('albums_compilationalbumrelease', 'album_id')

        # Changing field 'CompilationAlbumRelease.albumrelease_ptr'
        db.alter_column('albums_compilationalbumrelease', 'albumrelease_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['albums.AlbumRelease'], unique=True))

        # User chose to not deal with backwards NULL issues for 'ArtistAlbumRelease.artistalbum_ptr'
        raise RuntimeError("Cannot reverse this migration. 'ArtistAlbumRelease.artistalbum_ptr' and its values cannot be restored.")

        # Deleting field 'ArtistAlbumRelease.album'
        db.delete_column('albums_artistalbumrelease', 'album_id')

        # Changing field 'ArtistAlbumRelease.albumrelease_ptr'
        db.alter_column('albums_artistalbumrelease', 'albumrelease_ptr_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['albums.AlbumRelease'], unique=True))
    ...
    models = {
        ...
        'albums.artistalbumrelease': {
            'Meta': {'object_name': 'ArtistAlbumRelease', '_ormbases': ['albums.AlbumRelease']},
            'album': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'releases'", 'to': "orm['albums.ArtistAlbum']"}),
            'albumrelease_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['albums.AlbumRelease']", 'unique': 'True', 'primary_key': 'True'})
        },
        'albums.artistalias': {
        ...
        'albums.compilationalbumrelease': {
            'Meta': {'object_name': 'CompilationAlbumRelease', '_ormbases': ['albums.AlbumRelease']},
            'album': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'releases'", 'to': "orm['albums.CompilationAlbum']"}),
            'albumrelease_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['albums.AlbumRelease']", 'unique': 'True', 'primary_key': 'True'})
        },
        'albums.disc': {
