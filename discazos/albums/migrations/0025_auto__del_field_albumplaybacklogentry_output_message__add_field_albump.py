...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AlbumPlaybackLogEntry.output_message'
        db.delete_column('albums_albumplaybacklogentry', 'output_message')

        # Adding field 'AlbumPlaybackLogEntry.loading_status'
        db.add_column('albums_albumplaybacklogentry', 'loading_status', self.gf('django.db.models.fields.CharField')(default='DL_FETCH_INIT', max_length=50), keep_default=False)

        # Adding field 'AlbumPlaybackLogEntry.extra_debug_info'
        db.add_column('albums_albumplaybacklogentry', 'extra_debug_info', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'AlbumPlaybackLogEntry.latest_update'
        db.add_column('albums_albumplaybacklogentry', 'latest_update', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime.now(), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AlbumPlaybackLogEntry.output_message'
        raise RuntimeError("Cannot reverse this migration. 'AlbumPlaybackLogEntry.output_message' and its values cannot be restored.")

        # Deleting field 'AlbumPlaybackLogEntry.loading_status'
        db.delete_column('albums_albumplaybacklogentry', 'loading_status')

        # Deleting field 'AlbumPlaybackLogEntry.extra_debug_info'
        db.delete_column('albums_albumplaybacklogentry', 'extra_debug_info')

        # Deleting field 'AlbumPlaybackLogEntry.latest_update'
        db.delete_column('albums_albumplaybacklogentry', 'latest_update')
    ...
    models = {
        ...
        'albums.albumplaybacklogentry': {
            'Meta': {'object_name': 'AlbumPlaybackLogEntry'},
            'album_release': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['albums.AlbumRelease']"}),
            'album_release_dl_source': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['albums.AlbumReleaseDownloadSource']"}),
            'date_and_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'extra_debug_info': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_update': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'loading_status': ('django.db.models.fields.CharField', [], {'default': "'DL_FETCH_INIT'", 'max_length': '50'}),
        ...
        'albums.disctrack': {
            ...
            'number': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'song_name': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
