...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumReleaseDownloadSource.enabled'
        db.add_column('albums_albumreleasedownloadsource', 'enabled', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlbumReleaseDownloadSource.enabled'
        db.delete_column('albums_albumreleasedownloadsource', 'enabled')
