...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AlbumRelease.release_date'
        db.delete_column('albums_albumrelease', 'release_date')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AlbumRelease.release_date'
        raise RuntimeError("Cannot reverse this migration. 'AlbumRelease.release_date' and its values cannot be restored.")
    ...
    models = {
        ...
        'albums.albumrelease': {
            ...
            'release_year': ('django.db.models.fields.IntegerField', [], {'max_length': '4', 'blank': 'True'}),
