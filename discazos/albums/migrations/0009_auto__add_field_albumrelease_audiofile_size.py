...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumRelease.audiofile_size'
        db.add_column('albums_albumrelease', 'audiofile_size', self.gf('django.db.models.fields.BigIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlbumRelease.audiofile_size'
        db.delete_column('albums_albumrelease', 'audiofile_size')
