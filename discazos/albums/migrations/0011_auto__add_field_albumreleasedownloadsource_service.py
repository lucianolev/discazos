...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumReleaseDownloadSource.service'
        db.add_column('albums_albumreleasedownloadsource', 'service', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['albums.FileHostingService']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlbumReleaseDownloadSource.service'
        db.delete_column('albums_albumreleasedownloadsource', 'service_id')
