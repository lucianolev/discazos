...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumRelease.uploaded_on'
        db.add_column('albums_albumrelease', 'uploaded_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 6, 29, 1, 24, 16, 677974), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlbumRelease.uploaded_on'
        db.delete_column('albums_albumrelease', 'uploaded_on')
