...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AlbumReleaseDownloadSource.provider'
        db.delete_column('albums_albumreleasedownloadsource', 'provider')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'AlbumReleaseDownloadSource.provider'
        raise RuntimeError("Cannot reverse this migration. 'AlbumReleaseDownloadSource.provider' and its values cannot be restored.")
