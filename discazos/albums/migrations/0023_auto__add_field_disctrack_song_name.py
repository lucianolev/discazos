...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DiscTrack.song_name'
        db.add_column('albums_disctrack', 'song_name', self.gf('django.db.models.fields.CharField')(default='SONG', max_length=255), keep_default=False)

	# Data migrate song to song_name
	for disc_track in orm.DiscTrack.objects.all():
		disc_track.song_name = orm.Song.objects.get(pk=disc_track.song.pk).name
		disc_track.save()


    def backwards(self, orm):
        
        # Deleting field 'DiscTrack.song_name'
        db.delete_column('albums_disctrack', 'song_name')
