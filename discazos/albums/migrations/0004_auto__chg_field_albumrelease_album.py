...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AlbumRelease.album'
        db.alter_column('albums_albumrelease', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['albums.Album']))


    def backwards(self, orm):
        
        # Changing field 'AlbumRelease.album'
        db.alter_column('albums_albumrelease', 'album_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['albums.ArtistAlbum']))
