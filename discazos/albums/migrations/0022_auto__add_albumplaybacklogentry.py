...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AlbumPlaybackLogEntry'
        db.create_table('albums_albumplaybacklogentry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('date_and_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('album_release', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['albums.AlbumRelease'])),
            ('output_message', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('album_release_dl_source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['albums.AlbumReleaseDownloadSource'])),
        ))
        db.send_create_signal('albums', ['AlbumPlaybackLogEntry'])


    def backwards(self, orm):
        
        # Deleting model 'AlbumPlaybackLogEntry'
        db.delete_table('albums_albumplaybacklogentry')
    ...
    models = {
        ...
        'albums.albumplaybacklogentry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'output_message': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
