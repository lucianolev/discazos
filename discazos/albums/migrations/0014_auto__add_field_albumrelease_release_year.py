...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumRelease.release_year'
        db.add_column('albums_albumrelease', 'release_year', self.gf('django.db.models.fields.IntegerField')(default=2012, max_length=4, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlbumRelease.release_year'
        db.delete_column('albums_albumrelease', 'release_year')
