...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumRelease.main_release'
        db.add_column('albums_albumrelease', 'main_release', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlbumRelease.main_release'
        db.delete_column('albums_albumrelease', 'main_release')
